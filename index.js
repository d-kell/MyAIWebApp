document.addEventListener('DOMContentLoaded', function() {
  fetch('https://izu3emoo4hi6o67mtrjiolijbi0oojur.lambda-url.us-east-1.on.aws') //Fetch LAMBDA FUNCTION URL - make sure to not add a trailing slash
  ...
  function generateAiDescription(imageId) {
    const aiDescriptionEndpoint = 'https://rexivlkyjbjukqpnuiqgyjcp5u0kbeps.lambda-url.us-east-1.on.aws'; // GENERATE AI LAMBDA FUNCTION URL - and 
